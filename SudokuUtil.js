...
const SudokuUtil = {
  // function to check if given puzzle is valid or not
  ...
  // function to check if particular place has valid value or not
...
// function to check if col is valid or not
...
// function to  check if 3*3 box is valid or not
